...
class _EditState extends State<Edit> {
  ...
  late TextEditingController desic;

  void editData() {
    var url = Uri.parse(
        'http://localhost/flutter_api/update.php'); //update api calling
    http.post(url, body: {
  ...
  void initState() {
    ...
    desic = TextEditingController(text: widget.list[widget.index]['desic']);
    super.initState();
  }
